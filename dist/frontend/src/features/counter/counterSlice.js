...
exports.incrementAsync = (0, toolkit_1.createAsyncThunk)('counter/fetchCount', function (amount) { return __awaiter(void 0, void 0, void 0, function () {
    var response;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, counterAPI_1.fetchCount)(amount)];
            case 1:
                response = _a.sent();
...
var incrementIfOdd = function (amount) {
    return function (dispatch, getState) {
        var currentValue = (0, exports.selectCount)(getState());
        if (currentValue % 2 === 1) {
